...
export const barterData: { [key: string]: TradeData[] } = {
  '티르코네일': [
    {
      id: 'nora_travelers_snack',
      npc: '노라',
  ...
  '두갈드아일': [
    ...
    },
    {
      id: 'elvin_superior_wood',
      npc: '엘빈',
      itemId: 'stir_fried_vegetables',
      itemQuantity: 1,
      requiredItemId: 'superior_wood',
      requiredQuantity: 4,
      limitType: 'daily',
      limitCount: 2
    },
