...
export const potionCraftRecipes: Recipe[] = [
  ...
  // Lv15 - 퀴아난 회복 물약
  {
    id: 'craft_quianan_healing_potion_5',
    name: '퀴아난 회복 물약 x5',
    resultItemId: 'quianan_healing_potion_5',
    resultQuantity: 5,
    requiredItems: [
      { itemId: 'bloody_herb', quantity: 16 },
      { itemId: 'clean_mushroom_juice', quantity: 6 },
      { itemId: 'sprout_mushroom', quantity: 5 },
      { itemId: 'tough_mushroom', quantity: 2 }
    ],
    category: RECIPE_CATEGORY.CRAFT_POTION,
    facilityLevel: 15,
    craftingTime: 960
  ...
  // Lv20 - 퀴아난 자동회복 물약
  {
    id: 'craft_quianan_auto_healing_potion_5',
    name: '퀴아난 자동회복 물약 x5',
    resultItemId: 'quianan_auto_healing_potion_5',
    resultQuantity: 5,
    requiredItems: [
      { itemId: 'quianan_healing_potion_5', quantity: 5 },
      { itemId: 'disassembled_equipment_part', quantity: 10 }
    ],
    category: RECIPE_CATEGORY.CRAFT_POTION,
    facilityLevel: 20,
  ...
  // Lv22 - 퀴아난 붕대
  {
    id: 'craft_quianan_bandage_5',
    name: '퀴아난 붕대 x5',
    resultItemId: 'quianan_bandage_5',
    resultQuantity: 5,
    requiredItems: [
  ...
  // Lv25 - 퀴아난 회복 물약S
  {
    id: 'craft_quianan_healing_potion_s_5',
    name: '퀴아난 회복 물약S x5',
    resultItemId: 'quianan_healing_potion_s_5',
    resultQuantity: 5,
    requiredItems: [
      { itemId: 'bloody_herb', quantity: 20 },
      { itemId: 'sprout_mushroom_essence', quantity: 5 },
  ...
  // Lv27 - 최상급 내열 붕대
  {
    id: 'craft_supreme_heat_resistant_bandage_5',
    name: '최상급 내열 붕대 x5',
    resultItemId: 'supreme_heat_resistant_bandage_5',
    resultQuantity: 5,
    requiredItems: [
  ...
  // Lv27 - 최상급 방한 붕대
  {
    id: 'craft_supreme_cold_resistant_bandage_5',
    name: '최상급 방한 붕대 x5',
    resultItemId: 'supreme_cold_resistant_bandage_5',
    resultQuantity: 5,
    requiredItems: [
      { itemId: 'supreme_bandage', quantity: 5 },
      { itemId: 'strong_herb_powder', quantity: 6 },
  ...
  // Lv27 - 최상급 절연 붕대
  {
    id: 'craft_supreme_insulation_bandage_5',
    name: '최상급 절연 붕대 x5',
    resultItemId: 'supreme_insulation_bandage_5',
    resultQuantity: 5,
    requiredItems: [
      { itemId: 'supreme_bandage', quantity: 5 },
      { itemId: 'strong_herb_powder', quantity: 6 },
  ...
  // Lv27 - 최상급 축복의 붕대
  {
    id: 'craft_supreme_blessing_bandage_5',
    name: '최상급 축복의 붕대 x5',
    resultItemId: 'supreme_blessing_bandage_5',
    resultQuantity: 5,
    requiredItems: [
      { itemId: 'supreme_bandage', quantity: 5 },
      { itemId: 'strong_herb_powder', quantity: 6 },
  ...
  // Lv27 - 최상급 봉인의 붕대
  {
    id: 'craft_supreme_seal_bandage_5',
    name: '최상급 봉인의 붕대 x5',
    resultItemId: 'supreme_seal_bandage_5',
    resultQuantity: 5,
    requiredItems: [
      { itemId: 'supreme_bandage', quantity: 5 },
      { itemId: 'strong_herb_powder', quantity: 6 },
  ...
  // Lv29 - 퀴아난 자동회복 물약S
  {
    id: 'craft_quianan_auto_healing_potion_s_5',
    name: '퀴아난 자동회복 물약S x5',
    resultItemId: 'quianan_auto_healing_potion_s_5',
    resultQuantity: 5,
    requiredItems: [
      { itemId: 'quianan_healing_potion_s_5', quantity: 5 },
