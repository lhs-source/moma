      ...
      <div v-for="recipe in categoryRecipes" :key="recipe.id"
        ...
        <div class="flex items-start gap-3 mb-3">
          ...
          <div class="flex-1">
            ...
            <div class="text-sm text-gray-500">생산량: {{ recipe.resultQuantity || 1 }}개</div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <div class="pl-2">{{ formatTime(recipe.craftingTime || 0) }}</div>
          </div>
        ...
        <div class="flex justify-end mt-3">
          <button class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm" @click="addItem(recipe)">
            추가
          </button>
        </div>
      </div>
