          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
            <div v-for="trade in trades" :key="trade.id"
              ...
              <div class="flex items-center gap-3">
                ...
                <img :src="itemStore.getItemById(trade.itemId)?.imageUrl"
                  :alt="itemStore.getItemById(trade.itemId)?.name" class="w-10 h-10 object-contain" />
                <div>
              ...
              <button @click="tradeStore.toggleTrade(trade.id)"
