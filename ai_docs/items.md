...
This document contains all items from the game database in table format.

| ID | Name | Image URL | Description | Craftable | Category | From Trade | Price | Crafting Recipe |
|----|------|-----------|-------------|-----------|----------|------------|-------|-----------------|
| travelers_snack | 여행자 간식 | /images/items/travelers_snack.png | 여행 중에 먹기 좋은 간식 | false | 음식 | false | - | - |
| malcolms_pillow | 말콤의 푹신한 양털 베개 | /images/items/malcolms_pillow.png | 말콤이 만든 푹신한 베개 | true | 가구 | true | - | spider_web x5 |
| superior_wool | 상급 양털 | /images/items/superior_wool.png | 고급 양털 | false | 재료 | false | - | - |
| pet_food | 펫 먹이 | /images/items/pet_food.png | 펫을 위한 먹이 | false | 음식 | false | - | - |
| four_leaf_clover | 네잎클로버 | /images/items/four_leaf_clover.png | 행운을 가져다주는 네잎클로버 | false | 재료 | false | - | - |
| mushroom | 쑥쑥 버섯 | /images/items/mushroom.png | 자라는 버섯 | false | 재료 | false | - | - |
| alchemy_catalyst | 고급 룬합성 촉매 | /images/items/alchemy_catalyst.png | 연금술 실험에 사용되는 촉매 | false | 재료 | false | - | - |
| apple_juice | 사과 주스 | /images/items/apple_juice.png | 신선한 사과 주스 | true | 음식 | false | - | apple x3 |
| alchemy_powder | 연금술 부스러기 | /images/items/alchemy_powder.png | 연금술 실험의 부산물 | false | 재료 | false | - | - |
| rare_alchemy_catalyst | 레어 룬합성 촉매 | /images/items/rare_alchemy_catalyst.png | 희귀한 연금술 촉매 | false | 재료 | false | - | - |
| critical_potion | 치명타 비약 | /images/items/critical_potion.png | 치명타 확률을 높여주는 비약 | false | 물약 | false | - | - |
| mayonnaise_stir_fry | 마요네즈 고기볶음 | /images/items/mayonnaise_stir_fry.png | 마요네즈로 볶은 고기 요리 | true | 음식 | false | - | meat x2, mayonnaise x1 |
| blank_score | 빈 악보 | /images/items/blank_score.png | 작곡에 사용되는 빈 악보 | false | 음악 | false | - | - |
| wool | 양털 | /images/items/wool.png | 부드러운 양털 | false | 재료 | false | - | - |
| spider_web | 거미줄 | /images/items/spider_web.png | 거미가 만든 거미줄 | false | 재료 | false | - | - |
| workbench_blueprint | 다목적 제작대 설계도 (3레벨) | /images/items/blueprint.png | 다목적 제작대를 만들 수 있는 설계도 | false | 설계도 | false | - | - |
| campfire_kit | 전문 캠프파이어 키트 | /images/items/campfire_kit.png | 전문가용 캠프파이어 키트 | false | 도구 | false | - | - |
| holy_water | 성수 | /images/items/holy_water.png | 신성한 물 | false | 물약 | false | - | - |
| kaitin_bread | 케이틴 특제 통밀빵 | /images/items/kaitin_bread.png | 케이틴이 만든 특제 빵 | true | 음식 | false | - | wheat_flour x2, milk x1 |
| egg | 달걀 | /images/items/egg.png | 신선한 달걀입니다. | false | 재료 | false | - | - |
| meat | 고기 | /images/items/meat.png | 신선한 고기입니다. | false | 재료 | false | - | - |
| salt | 소금 | /images/items/salt.png | 소금입니다. | false | 재료 | false | 50 | - |
| water_bottle | 물이 든 병 | /images/items/water_bottle.png | 물이 담긴 병입니다. | false | 재료 | false | - | - |
| herb | 허브 | /images/items/herb.png | 향긋한 허브입니다. | false | 재료 | false | 30 | - |
| potato | 감자 | /images/items/potato.png | 신선한 감자입니다. | false | 재료 | false | - | - |
| sugar | 설탕 | /images/items/sugar.png | 설탕입니다. | false | 재료 | false | 40 | - |
| apple | 사과 | /images/items/apple.png | 신선한 사과입니다. | false | 재료 | false | - | - |
| cabbage | 양배추 | /images/items/cabbage.png | 신선한 양배추입니다. | false | 재료 | false | 25 | - |
| mayonnaise | 마요네즈 | /images/items/mayonnaise.png | 마요네즈입니다. | false | 재료 | false | - | - |
| onion | 양파 | /images/items/onion.png | 신선한 양파입니다. | false | 재료 | false | - | - |
| corn | 옥수수 | /images/items/corn.png | 신선한 옥수수입니다. | false | 재료 | false | - | - |
| cheese | 치즈 | /images/items/cheese.png | 신선한 치즈입니다. | false | 재료 | false | - | - |
| flour | 밀가루 | /images/items/flour.png | 밀가루입니다. | false | 재료 | false | - | - |
| clam | 조개 | /images/items/clam.png | 신선한 조개입니다. | false | 재료 | false | - | - |
...
| superior_fabric_plus | 상급 옷감+ | /images/items/superior_fabric_plus.png | 최고급 천 | false | 재료 | false | - | - |
...
| immortality_powder | 불사의 가루 | /images/items/default.webp | 불멸의 힘을 가진 신비로운 가루 | false | 재료 | false | - | - |
